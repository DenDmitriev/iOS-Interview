...
| Default | `PassThroughSubject`, `CurrentValueSubject`, `Just`, `Empty`, `Future`, `Fail`, `Sequence`, `@Published`  | `AnyCancellable`, `Set<AnyCancellable>` | `sink(receiveValue:)`, Custom Subscriber |
