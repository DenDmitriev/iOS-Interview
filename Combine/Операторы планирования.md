...
## debounce
Debounce (отскочить) - оператор отсрочки, который публикует элементы только после истечения заданного временного интервала между событиями издателя. То есть опубликует данные когда наступит пауза между событиями издателя длиной указанной в операторе.
