...
Задерживает публикацию всего вывода к нисходящему издателю на определенное время на определенном планировщике. 
```swift
var subscriptions = Set<AnyCancellable>()
...
<img width="702" alt="debounce" src="https://github.com/DenDmitriev/iOS-Interview/assets/65191747/8cc19cbb-7040-4042-86d6-64f0b94cc40d">


## throttle
Оператор который испускает данные собранные в течении указанного промежутка времени.
