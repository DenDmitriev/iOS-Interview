...
Как правило, вы будете применять @State для:
- Примитивы, такие как Int, String и т. д.
- Структуры, где мутация приводит к присвоению нового значения вашему @State.
- iOS 17+: @Observable объекты, которые принадлежат виду.
