...
## CleanSwift
CleanSwift — это хорошая альтернатива VIPER и ещё один способ переложить концепцию Чистой Архитектуры на iOS разработку. В отличие от VIPER, в CleanSwift парадигма UIKit с центральным элементом в виде UIViewController остается нетронутой, что позволяет нам сделать чистую архитектуру, не выдумывая велосипеды, а естественно вырастая из MVC. 
...
![CleanSwift](https://github.com/DenDmitriev/iOS-Interview/assets/65191747/f4387bad-936b-400f-9816-0846a1a0c49c)
...
![d1c715246862b23a25193ecda57edd3c](https://github.com/DenDmitriev/iOS-Interview/assets/65191747/f4bd9082-7f27-4f6f-bdf2-56941c567b2d)
...
<img width="250" alt="Middleware" src="https://github.com/DenDmitriev/iOS-Interview/assets/65191747/11272020-6b69-464d-95eb-c9598a19fbed">


## Источники:
- [ПАТТЕРНЫ ПРОЕКТИРОВАНИЯ](https://refactoring.guru/ru/design-patterns)
- [Архитектурные паттерны в iOS: привет от дядюшки Боба, или Clean Architecture](https://habr.com/ru/companies/croc/articles/560674/)
