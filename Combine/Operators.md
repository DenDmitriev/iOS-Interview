...
## CombineLatest
Издатель, комбинирующий последние значения каждого из издателей и отправляющий результат в виде кортежа.
...
## switchToLatest
Позволяет нам объединить серию паблишеров в один поток событийс возомжностью переключаться между ними.
Этот оператор сглаживает издателя издателей, которым мы хотим отслеживать значения, опубликованные с последнего отправленного издателя. Взгляните на этот код:
...
В каждом операторе планирования используется планировщик. Планировщик оперделяет где будет осуществляться работа операторов.
