...
Наша модель данных созданная в предыдущих статьях (CoreData, Relations) не имеет достаточной информации о планетах в солнечной системе. А имеено не имеет верной сортировки планет относительно звезды.
...
<img width="350" alt="Снимок экрана 2024-03-14 в 08 00 59" src="https://github.com/DenDmitriev/iOS-Interview/assets/65191747/332974b4-d1c0-47e4-b99e-a87f227c1476">
<img width="450" alt="Снимок экрана 2024-03-14 в 08 07 08" src="https://github.com/DenDmitriev/iOS-Interview/assets/65191747/a0697ae0-b273-47c4-9eff-489330798ec9">

Этот шаг создаст вторую версию вашей модели данных, но вам все еще нужно сообщить Xcode, чтобы он использовал новую версию в качестве рабочей модели. В инспекторе файла (File Inspector), справа вверху, найдите секцию Model Version. Выберите в поле "Current" CoreDataDocumentation v2. После того, как вы сделали это, обратите внимание, что у вас появилась зеленая отметка напротив новой версии модели данных:

<img width="258" alt="Снимок экрана 2024-03-14 в 08 11 27" src="https://github.com/DenDmitriev/iOS-Interview/assets/65191747/9ffb8a5d-c0b2-4695-add3-72851431c23b">
<img width="269" alt="Снимок экрана 2024-03-14 в 08 12 37" src="https://github.com/DenDmitriev/iOS-Interview/assets/65191747/4d6a3cd1-2623-4d1a-bad2-493b23ed63ca">
